      ...
      <section className="relative overflow-hidden rounded-[28px] border border-blue-200/20 bg-gradient-to-br from-[#06162d] via-[#0d2342] to-[#1d4f91] text-white shadow-[0_20px_60px_rgba(15,23,42,0.25)]">
        ...
        <div className={`relative grid gap-8 p-6 sm:p-8 ${isSuperAdmin ? "lg:grid-cols-[1fr_300px] lg:items-center" : ""}`}>
          <div>
            ...
            <p className="mt-3 max-w-lg text-sm leading-6 text-blue-100">{isSuperAdmin ? "Overview of institutional assignments, survey completion, and monitoring progress across Chairperson and Commissioner offices." : "Your office's institutional assignments, survey completion, and monitoring progress."}</p>
